...
def grid_search(dataname, runs, params, func,if_with_val):
  ...
  for params in generate_conf(params):
    score, std, result_msg = func(dataname, runs,if_with_val, **params)
    print(result_msg)
    result_mean_std = "mean_score: %s; std_score: %s, run_times: %s\n" % (score, std, runs)
